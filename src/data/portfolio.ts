...
export const portfolioSectionDetails = {
  ...
  articleCardItems: [
    {
      thumbnail: "/images/portfolio/portfolio-cards/eighty-days.jpg",
    ...
    {
      thumbnail: "/images/portfolio/portfolio-cards/richmonks.jpg",
      brandName: "RichMonks",
      chipItems: [
        "UI/UX Design",
        "Web App Development",
    ...
    {
      thumbnail: "/images/portfolio/portfolio-cards/sunali-class.jpg",
    ...
    {
      thumbnail: "/images/portfolio/portfolio-cards/pango.jpg",
      brandName: "Pango",
      chipItems: [
        "UI/UX Design",
        "Product Planning",
        ...
        "Automation",
        "Health Tech",
        "Custom Algorithm Development (Diet Maker)",
      ],
    ...
    {
      thumbnail: "/images/portfolio/portfolio-cards/gobindgarh.jpg",
    ...
    },
    {
      ...
      brandName: "Custom AI Research Project",
      chipItems: [
        "Machine Learning",
        "AI Model Training",
        "Frontend Interface",
