export const servicesData = {
  "product-strategy-&-planning": {
    ...
    painSolution: [
      {
        problem: "Unclear MVP",
        solution: "Clear MVP definition",
      },
      {
        problem: "Scope creep",
        solution: "Locked feature scope",
      },
      {
        problem: "Conflicting priorities",
        solution: "Prioritized product roadmap",
      },
    ],
    howWeWork: [
      ...
      {
        description:
          "Create a realistic roadmap with trade-offs clearly called out",
      },
    ],
    deliverables: [
    ...
    finalCTA:
      "If you’re unsure what to build first, let’s fix that before you build anything.",
  },
  ...
  "full-stack-development": {
    ...
    finalCTA:
      "If you want your product built right the first time, let’s talk.",
  },
  ...
  "ai-&-automation": {
    ...
    painSolution: [
      ...
      },
      {
        ...
        solution: "Insight-driven systems",
      },
      {
        problem: "Unclear AI ROI",
        solution: "Measurable AI use cases",
      },
    ],
    howWeWork: [
    ...
    finalCTA:
      "If AI feels confusing or overhyped, we’ll make it practical.",
  },
  ...
  "cloud,-devops-&-infrastructure": {
    ...
    painSolution: [
      ...
      {
        problem: "Downtime issues",
        solution: "Scalable infrastructure",
      },
      {
        problem: "Rising cloud costs",
        solution: "Cost-optimized setups",
      },
    ],
    howWeWork: [
  ...
  "business-tools-&-internal-systems": {
    ...
    painSolution: [
      ...
      },
      {
        ...
        solution: "Centralized dashboards",
      },
      {
        problem: "Rigid software",
        solution: "Workflow-first systems",
      },
    ],
    howWeWork: [
  ...
  "industry-specific-solutions": {
    ...
    painSolution: [
      {
        problem: "Generic software",
        solution: "Domain-specific builds",
      },
      {
        problem: "Low adoption",
        solution: "Familiar workflows",
      },
      {
        problem: "Scaling bottlenecks",
        solution: "Growth-ready systems",
      },
    ],
    howWeWork: [
    ...
    finalCTA:
      "If generic software is holding you back, custom might be the answer.",
  },
};